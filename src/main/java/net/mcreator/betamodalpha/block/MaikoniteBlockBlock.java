...
public class MaikoniteBlockBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:maikonite_block")
	public static final Block block = null;
	public MaikoniteBlockBlock(BetamodAlphaModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maikonite_block");
		}
