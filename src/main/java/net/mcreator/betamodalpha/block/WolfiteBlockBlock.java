...
public class WolfiteBlockBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:wolfite_block")
	public static final Block block = null;
	public WolfiteBlockBlock(BetamodAlphaModElements instance) {
		super(instance, 53);
	}
