...
public class AlphiteBlockBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:alphite_block")
	public static final Block block = null;
	public AlphiteBlockBlock(BetamodAlphaModElements instance) {
		super(instance, 12);
	}
