...
public class AlphiteOreBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:alphite_ore")
	public static final Block block = null;
	public AlphiteOreBlock(BetamodAlphaModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlphiteItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("betamod_alpha:alphite_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("alphite_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("betamod_alpha:alphite_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
