...
import net.mcreator.betamodalpha.item.TestyiumDustItem;
...
public class TestyiumOreBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:testyium_ore")
	public static final Block block = null;
	public TestyiumOreBlock(BetamodAlphaModElements instance) {
		super(instance, 93);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TestyiumDustItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("betamod_alpha:testyium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("testyium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("betamod_alpha:testyium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
