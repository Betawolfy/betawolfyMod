...
import net.mcreator.betamodalpha.item.AlphariteItem;
...
public class AlphariteOreBlock extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:alpharite_ore")
	public static final Block block = null;
	public AlphariteOreBlock(BetamodAlphaModElements instance) {
		super(instance, 87);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlphariteItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("betamod_alpha:alpharite_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("alpharite_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("betamod_alpha:alpharite_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
