...
public class MaikoniteHoeItem extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:maikonite_hoe")
	public static final Item block = null;
	public MaikoniteHoeItem(BetamodAlphaModElements instance) {
		super(instance, 20);
	}
