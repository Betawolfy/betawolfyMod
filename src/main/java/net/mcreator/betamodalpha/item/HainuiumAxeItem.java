...
public class HainuiumAxeItem extends BetamodAlphaModElements.ModElement {
	@ObjectHolder("betamod_alpha:hainuium_axe")
	public static final Item block = null;
	public HainuiumAxeItem(BetamodAlphaModElements instance) {
		super(instance, 14);
	}
